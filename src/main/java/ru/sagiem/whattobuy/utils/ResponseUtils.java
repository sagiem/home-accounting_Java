...
public class ResponseUtils {
    ...
    public static final String SHOPPING_DELETE_MESSAGE = "Покупка успешно удалена";

    public static final String SHOPPING_PROJECT_NOT_FOUND_EXCEPTION_MESSAGE = "Проект покупок не найдет";
